# ----------------------------------------------------------------------------------------------
# c001 ddos 
# This tool can take down government websites
#
#
# created by: c00lr
# ----------------------------------------------------------------------------------------------
...
def show_usage():
    print(colorama.Fore.GREEN+'Structive (fixed version of saphyra lol)')
    print(colorama.Fore.GREEN+'How to use => python3 structive.py <url>')
    print(colorama.Fore.GREEN+'e.g. python3 structive.py http://getalife.net')
